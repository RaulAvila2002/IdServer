              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-6 col-md-3 text-center">
                    ...
                    <input type="text" class="knobEntrada_<?php echo $dispositivo->device_serie?>"  data-thickness=".2" data-angleArc="250" data-angleOffset="-125" value="0" data-width="120" data-height="100" readonly="true" data-fgColor="#66CC66" data-max="270">
