...
function traedata(){
    var AppID="bc86b34949388";
    var AppSecret="Mjk0Mzg5MDYwNzUwMzI1NjI4ODQ2NjU3MTcwNTQzMDgzNTC";
     //https://cors-anywhere.herokuapp.com/
    $.ajax({
        type: "GET",
        dataType: "json",
        url: "https://cors-anywhere.herokuapp.com/http://webiot.com.ar:8090/api/v4/brokers",
...
function suscription(page){
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: `https://cors-anywhere.herokuapp.com/http://webiot.com.ar:8090/api/v4/subscriptions?_page=${page}&_limit=10`,
        beforeSend: function (xhr){
          xhr.setRequestHeader('Authorization', "Basic " + btoa(AppID+":"+AppSecret));
        },
        success : function(data) {
...
function clientes(page2){
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: `https://cors-anywhere.herokuapp.com/http://webiot.com.ar:8090/api/v4/clients?_page=${page2}&_limit=10`,
        beforeSend: function (xhr){
